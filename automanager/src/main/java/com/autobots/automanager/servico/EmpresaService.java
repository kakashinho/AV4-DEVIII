...
public interface EmpresaService {
    ...
    //  Telefones e endereço da empresa
    void associarTelefone(Long empresaId, Long telefoneId);
    void desassociarTelefone(Long empresaId, Long telefoneId);
    void removerEndereco(Long empresaId);
    ...
    VendaResponse criarVenda(Long empresaId, VendaRequest request, Authentication authentication);
